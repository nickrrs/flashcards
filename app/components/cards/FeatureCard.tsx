...
export default function FeatureCard({ icon, title, description, visual }: FeatureCardProps) {
    return (
        <div className="relative w-full h-full max-w-full md:max-w-[588px] p-6 md:p-8 group bg-[#FDFDFD] transition-all duration-500 hover:bg-[#F9F9F9] saturate-100 rounded-2xl border border-gray-200 shadow-sm hover:shadow-md cursor-pointer">
